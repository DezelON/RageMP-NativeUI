...
/* harmony default export */ const enums_BadgeStyle = (BadgeStyle);
...
/* harmony default export */ const enums_Font = (Font);
...
class UIMenuItem {
    constructor(text, description = "") {
        ...
        this._text = new ResText(text, new Point(8, 0), 0.33, Color.WhiteSmoke, enums_Font.ChaletLondon, Alignment.Left);
...
class UIMenuListItem extends UIMenuItem {
    constructor(text, description = "", collection = new ItemsCollection([]), startIndex = 0) {
        ...
        this._itemText = new ResText("", new Point(290, y + 104), 0.35, Color.White, enums_Font.ChaletLondon, Alignment.Right);
    }
    get Collection() {
...
class NativeUI {
    constructor(title, subtitle, offset, spriteLibrary, spriteName) {
        ...
        this._descriptionText = new ResText("Description", new Point(this.offset.X + 5, 125), 0.35, new Color(255, 255, 255, 255), enums_Font.ChaletLondon, Alignment.Left);
...
exports.BadgeStyle = enums_BadgeStyle;
exports.Point = Point;
exports.Size = Size;
exports.Color = Color;
exports.Font = enums_Font;
